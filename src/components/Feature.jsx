      ...
      <Container>
        <div>
          ...
          <p className="mt-2 text-lg text-customDark-400 ml-32">
            EcoTrack was created for environmentally conscious individuals like
            you who are determined to make a difference
            <br />
            and won&#39;t let anything stand in the way of a greener future.
            <br />
            If other apps hesitate to push boundaries, EcoTrack Social embraces
            innovation.
          </p>
        </div>
      </Container>
