...
const Account = () => {
  return (
    <section
      id="account"
      aria-label="Features for building a portafolio"
      className="py-20 sm:py-32"
    >
      <Container>
        <div className="max-w-2xl mx-auto sm:text-center">
          <Title title="Your Green Journey Starts Here" className="text-2xl" />
          <p className="mt-2 text-lg text-gray-600">
            Join a community of eco-conscious individuals, track your progress
            and inspire others.
          </p>
        </div>
        <ul
